	...
	<div class="project">
		...
		<form name="frm" method="post" action="UserServlet">
			...
			<div class="field">
				...
				<input type="button" value="우편번호 검색" onclick="findAddress()"><br><br>
			</div>
			<div class="field">
			...
			<div class="field" style="display: none;">
				<label for="register_date">가입일</label><br>
				<input type="text" id="register_date" name="register_date" readonly><br><br>
			</div>
			<div class="field" style="display: none;">
				<label for="is_admin">관리자 여부</label><br>
